...
export const INTERCOM_ATTR_REFERRAL_SOURCE = 'Referral Source';
export const INTERCOM_ATTR_REFERRAL_DATE = 'Referral Date';
export const INTERCOM_ATTR_REFERRAL_REASON = 'Referral Reason';
...
export const INTERCOM_ATTR_OUTGOING_REFERRAL = 'Outgoing Referral';
export const INTERCOM_ATTR_OUTGOING_REFERRAL_REASON = 'Outgoing Referral Reason';
